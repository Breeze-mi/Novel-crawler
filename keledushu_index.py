# keledushu_index.py
# 组件：负责从 keledushu 风格的书籍详情页获取并解析出“全部章节”目录
# 提供的函数：
#   - fetch_html(url, timeout=20, retries=3)
#   - extract_chapter_list_from_index_precise_fixed(index_html, base_url)
# 该模块不依赖 GUI，可单独测试或复用在其它脚本中。
